...
- **承認** — サークルの設立・廃止、施設予約の申請を承認／却下する。**自分の印影で押し、誰がいつ何を通したかが記録に残る**。空いた判子欄と、止まっている日数が見える
- **予約のまとめて承認** — 承認待ちの予約を選んで一度に通す。通らなかった分は理由を出す
- **申請書の印刷** — 承認済みの申請を、印影の並んだ A4 の申請書として出す
...
いまの件数は、データベース側が **72件**、画面側が **62件**（広い画面と狭い画面の合計）です。
